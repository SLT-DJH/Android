...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //Intent로 로그인 정보(프로필 사진, 이름) 가져오기
        Intent intent = getActivity().getIntent();
        String nickName = intent.getStringExtra("nickName");

        TextView profileName = (TextView) v.findViewById(R.id.profileNameTextView);
        ...
        LinearLayout mylist = (LinearLayout) v.findViewById(R.id.myQuestView);
        ...
        LinearLayout signOut = (LinearLayout) v.findViewById(R.id.signoutView);
